    ...
    (function next() {
      ...
      fs.stat(base + file, function(err, stat) {
        if (stat && stat.isDirectory()) {
          ...
          if (file.indexOf('/plugins/') == -1 && file.indexOf('.txt') == -1 && file.indexOf('.ini') == -1 && file.indexOf('filesTemp.json') == -1 && file.indexOf('devFiles.json') == -1 && file.indexOf('.log') == -1 && file.indexOf('.git') == -1 && file.indexOf('.DS_Store') == -1 && file.indexOf('node_modules') == -1 && file.indexOf('backup') == -1) {
          results.push(file);
            }
          next();
        }
